...
return [
    ...
    */
    ...
    'cloudName'  => env('CLOUDINARY_CLOUD_NAME', 'plateau'),
    ...
    'apiKey'     => env('CLOUDINARY_API_KEY', '531426462529324'),
    'apiSecret'  => env('CLOUDINARY_API_SECRET', 'oPtLPcjBSts5Ezx5GitlohtZgss'),
