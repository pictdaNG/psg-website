...
@section('title')
  Plateau State Internal Revenue Service | Plateau State Government Website
@endsection
...
@section('subheader')
  About Plateau State Internal Revenue Service
@endsection
...
@section('content')
  <div class="content uk-width-1-2@m">
    ...
    <p>
      ...
      <ol>
        <li>Executive Chairman of the service who also doubles as the chairman of the Board members.</li>
        <li>Two Permanent Members. </li>
        <li>
          Eight Departments namely

          <ol type="i">
            <li>Administration and personnel management</li>
            <li>Personal income tax (Direct Assessment)</li>
            <li>Personal income tax (Pay as you earn)</li>
            <li>Finance and Supplies</li>
            <li>Other taxes</li>
            <li>Collection, Accounting and Planning</li>
            <li>Motor vehicle administration</li>
            <li>Tax Audit, monitoring and investigation</li>
            <li>Units, namely </li>
            <li>Legal unit </li>
            <li>Internal audit</li>
            <li>Planning research and statistics </li>
            <li>Management information system (MIS) </li>
            <li>Customer care unit </li>
            <li>Information and protocol </li>
            <li>Library </li>
            <li>Enforcement unit</li>
          </ol>
        </li>
      </ol>
    </p>
    ...
    <p>
      The essence is:
      <ul>
        <li>To encourage taxpayers to come forward and submit themselves for taxation.</li>
        <li>To reduce the high incidence of tax evasion by this group of taxpayers.</li>
        <li>To encourage taxpayer completing the self-assessment which they are entitled to a bonus of 1percent i.e. the tax payable shall be 1% less the actual tax computed.</li>
      </ul>
    </p>
