...
@section('title')
    Massive turnout in Tudun Wada as Plateau votes to determine governor | Plateau State Government Website
@endsection

@section('header')
    Massive turnout in Tudun Wada as Plateau votes to determine governor
@endsection
...
@section('content')
    <div class="content uk-width-1-2@m">
        ...
        <p>NAN also observed that the voters were orderly and peaceful.</p>
