...
@section('content')
    <div class="content uk-width-1-2@m">
        <h2 class="bold">The Executive</h2>
        <p>The power of the Executive Branch is vested in the State Governor, who is also responsible for implementing and enforcing the laws made by the State Assembly and, to that end, appoints the heads of agencies, including the Cabinet. The State Executive makes policies and implements them. The Deputy Governor is also part of the Executive Branch. The Cabinet and independent agencies of Government are responsible for the day-to-day enforcement and administration of laws. These departments and agencies have missions and responsibilities as widely divergent as their names.</p>

        <div class="uk-child-width-1-1@m uk-grid-small" uk-grid>
            <img class="object-fit" src="{{ URL::asset('/assets/img/executive.jpg') }}" alt="">
        </div>
