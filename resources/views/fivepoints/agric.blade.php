...
@section('title')
    AGRICULTURE AND RURAL DEVELOPMENT | Plateau State Government Website
@endsection
...
@section('content')
    <div class="content uk-width-1-2@m">        
        ...
        <ul>
            <li>
                <strong>Sustainable Development Goals (SDGs):</strong>  The complementary roles of the SDGs in the development of the state since the inception of this administration cannot be ignored. Between 2015 and 2016, the SDGs office has constructed 86 classrooms, 20 PHCs, 17 Boreholes and 9 VIP toilets in rural areas of the state. In September 2016, it donated 13 state-of the-art ambulances to 6 LGAs in the State-Jos North, B/Ladi, Mangu, Kanke, Shendam and Wase.
            </li>

            <li>
                <strong>Agricultural Transformation Agenda Support Program (ATASP): </strong> In order to maximize inputs in the areas of rural development, the administration has keyed into the intervention opportunities available at the AFDB-funded Agricultural Transformation Agenda Support Programme in the areas of social infrastructure such as schools, health centres, market stalls and technology centres. 
            </li>

            <li>
                <strong>Farm Inputs Distribution: </strong> Prompt and transparent distribution of fertilizers, herbicides, pesticides and other farm inputs to Farmers in the state was undertaken in the previous farming seasons. In particular, the agricultural policy of the administration is aimed at removing the inefficient fertilizer subsidy regime in fertilizer supply in order to benefit small-holder and large-scale farmers.
            </li>

            <li>
                <strong>Ranching Policy: </strong> In line with the yearnings and aspirations of the people, the administration has adopted the ranching policy as opposed to grazing reserves and permanent grazing routes, which were approved and Gazetted by the immediate past administration. This is aimed at increasing livestock production, scaling up economic empowerment and protection of the environment through modern concept of ranching. The policy also has a security component, which is aimed at curbing incessant herdsmen/farmers clashes, which in the previous years have been the bane of our progress and development as a state.
            </li>

            <li>
                <strong>Panyam Fish Farm: </strong> Which is the largest in Nigeria with a land mass of 309 hectares and a capacity to produce 10 million fingerlings and 4.9 tons of fish annually has been resuscitated through PPP with SOLBEC Ltd. 
            </li>

            <li>
                <strong>Transformation of 20 Earth Dams: </strong> With a total water surface area of 673 hectares and 12 natural lakes with 365 hectares of water surface area are being repositioned towards large-scale irrigation farming in the state.
            </li>

            <li>
                <strong>Fadama Bank: </strong> In order to boost agriculture through access to loans and other financial facilities to farmers, Government is working assiduously towards the establishment of a Fadama Bank from Fadama User Equity (FUEF)
            </li>
        </ul>
